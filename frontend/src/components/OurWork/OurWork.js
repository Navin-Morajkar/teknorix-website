...
const OurWork = () => {
  return (
    ...
    <div className="relative w-80 h-80 bg-green-500 border border-gray-300 transition-transform duration-300 transform flex flex-col items-center justify-center group">
          ...
          <button className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-3xl hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            Explore now
          </button>
