...
export default function Home({ headerData, serviceData,ourJobsData }) {
  ...
  return (
    <div>
      ...
      <ContainerRight data={filterService(serviceData,"CustomSoftwareDevelopment", 1)} />
      <ContainerLeft data={filterService(serviceData,"CustomSoftwareDevelopment", 2)} />
      <ContainerRight data={filterService(serviceData,"CustomSoftwareDevelopment", 3)} />
      

      <Header data={getDataBySortOrder(headerData,2)} />
      <ContainerRight data={filterService(serviceData,"ManagedITServices", 1)} />
      <ContainerLeft data={filterService(serviceData,"ManagedITServices", 2)} />
      <ContainerRight data={filterService(serviceData,"ManagedITServices", 3)} />
