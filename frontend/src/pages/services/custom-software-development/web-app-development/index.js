...
export async function getServerSideProps() {
  const headerResponse = await fetch("http://13.233.214.226:1337/api/headers?populate=*&filters[page][$eq]=WebDevelopment");
...
export default function Home({ headerData, serviceAdvantageData,serviceVectorData }) {
  ...
  const filteredTechnology = filterImageByType(serviceVectorData, "WebTechnology");
  return (
    <div>
